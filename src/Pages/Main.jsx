...
function Main() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post('https://teknologia-backend.onrender.com/upload', formData, {
        headers: {
  ...
  const fetchData = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(`https://teknologia-backend.onrender.com/data?page=${currentPage}`);
  ...
  const handleDelete = async (id) => {
    ...
    if (window.confirm('Are you sure you want to delete this item?')) {
      try {
        await axios.delete(`https://teknologia-backend.onrender.com/data/${id}`);
        fetchData();
      } catch (error) {
